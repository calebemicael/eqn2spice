...
public class EQN2Spice {
    ...
    public static int wPUN = 7000;
    public static int wPDN = 4000;
     ...
     *
     * @param in EQN file.
     * @param out SPICE file to be created. It takes the EQN file and outputs
     * the corresponding sized spice file.
     */
    ...
    /**
     *
     * @param in EQN file. It outputs the corresponding Spice file in standard
     * output.
     */
    ...
    private static String base() {
        ...
        try {
            ...
            sb.append(pun.toString().replace("VCC", "vcc"));// a little gambiarra
            sb.append(pdn.toString().replace("GND", "gnd"));// a little gambiarra
            sb.append("\n.ends\n");
